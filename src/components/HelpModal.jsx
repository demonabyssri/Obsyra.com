...
const HelpModal = ({ isOpen, onClose, contactEmail }) => {
        ...
        >
          ...
          >
            ...
            <div className="space-y-6 text-sm text-muted-foreground">
              <section>
                <h3 className="text-lg font-semibold text-foreground mb-2">¿Cómo usar Phantom Deals?</h3>
                <p>¡Bienvenido a Phantom Deals! Aquí puedes explorar un catálogo de productos variados. Si encuentras algo que te gusta:</p>
                <ul className="list-disc list-inside space-y-1 mt-2 pl-2">
                  ...
                  <li>Para comprar, añade el producto a tu <strong className="text-foreground">Carrito</strong> y procede al pago.</li>

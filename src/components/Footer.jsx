...
const Footer = ({ storeName, currency, setCurrency }) => {
  const currencies = [
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8 text-center md:text-left">
          <div>
            <div className="flex items-center justify-center md:justify-start space-x-2 mb-3">
              <div className="w-8 h-8 bg-gradient-to-r from-primary to-blue-500 rounded-lg flex items-center justify-center shadow-lg">
                <Ghost className="w-5 h-5 text-primary-foreground" />
              </div>
              <span className="text-xl font-bold text-foreground">{storeName}</span>
            </div>
            <p className="text-sm">
              Ofertas exclusivas y productos únicos de todo el mundo, directamente para ti.
            </p>
          </div>

    ...
    >
      ...
      <div className="bg-card p-6 sm:p-8 rounded-xl shadow-lg border border-border text-muted-foreground space-y-6">
        <section>
            ...
            <p>Estamos aquí para asistirte. Si tienes alguna pregunta sobre cómo usar Phantom Deals, encuentras algún problema técnico, o tienes alguna sugerencia, por favor contáctanos.</p>
        </section>

        <section>
            <h3 className="text-xl font-semibold text-foreground mb-2">Preguntas Frecuentes (Simulación)</h3>
            <div className="space-y-2">
                ...
                <div>
                    ...
                    <p>Añade productos a tu carrito y luego procede al pago desde la página del carrito. Recuerda que es una simulación.</p>
                </div>
                 <div>
                    <p className="font-medium text-card-foreground">¿Es esta una tienda real?</p>
                    <p>Phantom Deals es una plataforma de demostración creada para mostrar funcionalidades de e-commerce. Los productos y pagos son simulados.</p>
                </div>
            </div>
        </section>
